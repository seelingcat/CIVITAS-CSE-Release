...
-----------------------------------------------
	...
	("en_US",	"LOC_CSE_FAVOR_SUZERAIN_NAME",							"CSE - Favor for Suzerainty"		),
	("en_US",	"LOC_CSE_FAVOR_SUZERAIN_DESC",							"When enabled, suzerains receive +1 Favor per turn for each suzerained City-State. When disabled, there is no Favor gain from suzerainty."		),

	("en_US",	"LOC_CSE_FAVOR_CONSULAR_NAME",							"CSE - Consular City-State Bonus"		),
	("en_US",	"LOC_CSE_FAVOR_CONSULAR_DESC",							"When enabled, Consular City-States will grant Favor as Envoy Rewards. When disabled, they will grant Loyalty instead."		),
...
-----------------------------------------------
	...
	("en_US",	"LOC_CSE_ANURADHAPURA_TRAIT_DESCRIPTION",			"Your builders may construct Dagoba improvements.[NEWLINE][NEWLINE] Dagobas yield +1 [ICON_CULTURE] Culture and +1 [ICON_FAITH] Faith, with additional +1 [ICON_FAITH] Faith for every adjacent Holy Site and +1 [ICON_CULTURE] Culture for every adjacent Theater Square. Additional [ICON_CULTURE] Culture and [ICON_FAITH] Faith as you advance through the Civics and Technology trees. Building your first Dagoba grants a free Relic."	),
	...
	("en_US",	"LOC_IMPROVEMENT_CSE_DAGOBA_DESCRIPTION",			"Unlocks the Builder ability to construct a Dagoba.[NEWLINE][NEWLINE]Yields +1 [ICON_CULTURE] Culture and +1 [ICON_FAITH] Faith, with additional +1 [ICON_FAITH] Faith for every adjacent Holy Site and +1 [ICON_CULTURE] Culture for every adjacent Theater Square. Additional [ICON_CULTURE] Culture and [ICON_FAITH] Faith as you advance through the Civics and Technology trees. Building your first Dagoba grants a free Relic."	),
...
-----------------------------------------------
	...
	("en_US",	"LOC_CIVILIZATION_CSE_MEHRGARH_NAME",			"Mehrgarh"	),
	("en_US",	"LOC_CIVILIZATION_CSE_MEHRGARH_ADJECTIVE",		"Mehrgarh"	),
...
-----------------------------------------------
	...
	("en_US",	"LOC_CIVILIZATION_CSE_NALANDA_NAME",			"Taxila"	),
	("en_US",	"LOC_CIVILIZATION_CSE_NALANDA_ADJECTIVE",		"Taxila"	),
	...
	("en_US",	"LOC_CITY_NAME_CSE_TAXILA",						"{LOC_CIVILIZATION_CSE_NALANDA_NAME}"	),

	("en_US",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_NALANDA_CHAPTER_HISTORY_PARA_1",	"Taxila was an important city located in present-day Pakistan. It is best known for its ancient university, considered by some to be among the oldest in the world. It was the greatest center of learning in the region, bringing together people from around the region to study."	),
...
-----------------------------------------------
	...
	("en_US",	"LOC_CSE_SALE_SUZ_NAME",					"Salé Suzerain Bonus"	),
	("en_US",	"LOC_CSE_SALE_SUZ_DESC",					"+1 Attack for Naval Raiders (Salé)"	),
...
-----------------------------------------------
	...
	("en_US",	"LOC_CSE_SIDON_TRAIT_DESCRIPTION",			"+1 [ICON_MOVEMENT] Movement for all Civilian units."	),
	...
	("en_US",	"LOC_CSE_SIDON_SUZ_NAME",					"Sidon Suzerain Bonus"	),
	("en_US",	"LOC_CSE_SIDON_SUZ_DESC",					"+1 [ICON_MOVEMENT] for Civilians (Sidon)"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_MINOR_CIV_LARGEST_INFLUENCE_ENVOYS",				"10 [ICON_ENVOY] Envoys"			),

	("de_DE",	"LOC_CSE_FAVOR_SUZERAIN_NAME",							"CSE - Favor for Suzerainty"		),
	("de_DE",	"LOC_CSE_FAVOR_SUZERAIN_DESC",							"When enabled, suzerains receive +1 Favor per turn for each suzerained City-State. When disabled, there is no Favor gain from suzerainty."		),

	("de_DE",	"LOC_CSE_FAVOR_CONSULAR_NAME",							"CSE - Consular City-State Bonus"		),
	("de_DE",	"LOC_CSE_FAVOR_CONSULAR_DESC",							"When enabled, Consular City-States will grant Favor as Envoy Rewards. When disabled, they will grant Loyalty instead."		),

	("de_DE",	"LOC_CSE_WALLS_NAME",									"CSE - Free Walls for City-States"		),
	("de_DE",	"LOC_CSE_WALLS_DESC",									"When enabled, City-States will start with Walls in their city."		),

	("de_DE",	"LOC_CSE_ETHIOPIA_MODE_NAME",							"CSE - Alternate Envoy Bonuses"		),
	("de_DE",	"LOC_CSE_ETHIOPIA_MODE_DESC",							"When enabled, Envoy Bonuses will scale with building tier and will affect Diplomatic Quarter buildings, similar to the changes made in the New Frontier Ethiopia pack."		),

-----------------------------------------------
-- Scientific
-----------------------------------------------

	("de_DE",	"LOC_CSE_SCIENTIFIC_TRAIT_SMALL_INFLUENCE_BONUS",		"+2 [ICON_SCIENCE] Science in your [ICON_CAPITAL] Capital."		),
	("de_DE",	"LOC_CSE_SCIENTIFIC_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 [ICON_SCIENCE] Science in every Library."					),
	("de_DE",	"LOC_CSE_SCIENTIFIC_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 [ICON_SCIENCE] Science in every University."				),
	("de_DE",	"LOC_CSE_SCIENTIFIC_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 [ICON_SCIENCE] Science in every Research Lab."				),
	
	("de_DE",	"LOC_CSE_SCIENTIFIC_TRAIT_NAME",						"{LOC_CITY_STATES_TYPE_SCIENTIFIC} City-State"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CSE_CULTURAL_TRAIT_SMALL_INFLUENCE_BONUS",			"+2 [ICON_CULTURE] Culture in your [ICON_CAPITAL] Capital."			),
	("de_DE",	"LOC_CSE_CULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 [ICON_CULTURE] Culture in every Amphitheater."					),
	("de_DE",	"LOC_CSE_CULTURAL_TRAIT_LARGE_INFLUENCE_BONUS",			"+2 [ICON_CULTURE] Culture in every Art Museum or Artifact Museum."	),
	("de_DE",	"LOC_CSE_CULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 [ICON_CULTURE] Culture in every Broadcast Center."				),

	("de_DE",	"LOC_CSE_CULTURAL_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CULTURAL} City-State"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS",			"+4 [ICON_GOLD] Gold in your [ICON_CAPITAL] Capital."		),
	("de_DE",	"LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS",			"+4 [ICON_GOLD] Gold in every Market or Lighthouse."		),
	("de_DE",	"LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS_ALT",		"+4 [ICON_GOLD] Gold in every Market."						),
	("de_DE",	"LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS",			"+4 [ICON_GOLD] Gold in every Bank or Shipyard."			),
	("de_DE",	"LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS_ALT",		"+4 [ICON_GOLD] Gold in every Bank."						),
	("de_DE",	"LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS",			"+4 [ICON_GOLD] Gold in every Stock Exchange or Seaport."	),
	("de_DE",	"LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS_ALT",		"+4 [ICON_GOLD] Gold in every Stock Exchange."				),

	("de_DE",	"LOC_CSE_TRADE_TRAIT_NAME",								"{LOC_CITY_STATES_TYPE_TRADE} City-State"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CSE_RELIGIOUS_TRAIT_SMALL_INFLUENCE_BONUS",		"+2 [ICON_FAITH] Faith in your [ICON_CAPITAL] Capital."		),
	("de_DE",	"LOC_CSE_RELIGIOUS_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 [ICON_FAITH] Faith in every Shrine."					),
	("de_DE",	"LOC_CSE_RELIGIOUS_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 [ICON_FAITH] Faith in every Temple."					),
	("de_DE",	"LOC_CSE_RELIGIOUS_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 [ICON_FAITH] Faith in every Worship building."			),

	("de_DE",	"LOC_CSE_RELIGIOUS_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_RELIGIOUS} City-State"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CSE_MILITARISTIC_TRAIT_SMALL_INFLUENCE_BONUS",		"+2 [ICON_PRODUCTION] Production towards units in your [ICON_CAPITAL] Capital."				),
	("de_DE",	"LOC_CSE_MILITARISTIC_TRAIT_MEDIUM_INFLUENCE_BONUS",	"+2 [ICON_PRODUCTION] Production towards units in every city with a Barracks or Stable."	),
	("de_DE",	"LOC_CSE_MILITARISTIC_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 [ICON_PRODUCTION] Production towards units in every city with an Armory."				),
	("de_DE",	"LOC_CSE_MILITARISTIC_TRAIT_LARGEST_INFLUENCE_BONUS",	"+2 [ICON_PRODUCTION] Production towards units in every city with a Military Academy."		),

	("de_DE",	"LOC_CSE_MILITARISTIC_TRAIT_NAME",						"{LOC_CITY_STATES_TYPE_MILITARISTIC} City-State"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CSE_INDUSTRIAL_TRAIT_SMALL_INFLUENCE_BONUS",		"+2 [ICON_PRODUCTION] Production towards districts and buildings in your [ICON_CAPITAL] Capital."	),
	("de_DE",	"LOC_CSE_INDUSTRIAL_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 [ICON_PRODUCTION] Production towards districts and buildings in every city with a Workshop."	),
	("de_DE",	"LOC_CSE_INDUSTRIAL_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 [ICON_PRODUCTION] Production towards districts and buildings in every city with a Factory."		),
	("de_DE",	"LOC_CSE_INDUSTRIAL_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 [ICON_PRODUCTION] Production towards districts and buildings in every city with a Power Plant."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CITY_STATES_TYPE_CSE_AGRICULTURAL",					"Agrarian"	),
	
	("de_DE",	"LOC_CSE_AGRICULTURAL_TRAIT_SMALL_INFLUENCE_BONUS",			"+2 [ICON_FOOD] Food in the [ICON_CAPITAL] Capital."	),
	("de_DE",	"LOC_CSE_AGRICULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 [ICON_FOOD] Food in every Granary."					),
	("de_DE",	"LOC_CSE_AGRICULTURAL_TRAIT_LARGE_INFLUENCE_BONUS",			"+2 [ICON_FOOD] Food in every Sewer."					),
	("de_DE",	"LOC_CSE_AGRICULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 [ICON_FOOD] Food in every Aqueduct."				),

	("de_DE",	"LOC_CSE_AGRICULTURAL_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CSE_AGRICULTURAL} City-State"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CITY_STATES_TYPE_CSE_ENTERTAINMENT",					"Entertainment"	),
	
	("de_DE",	"LOC_CSE_ENTERTAINMENT_TRAIT_SMALL_INFLUENCE_BONUS",		"+1 [ICON_AMENITIES] Amenity in the [ICON_CAPITAL] Capital."	),
	("de_DE",	"LOC_CSE_ENTERTAINMENT_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+1 [ICON_AMENITIES] Amenity in every Arena."		),
	("de_DE",	"LOC_CSE_ENTERTAINMENT_TRAIT_LARGE_INFLUENCE_BONUS",		"+1 [ICON_AMENITIES] Amenity in every Zoo."	),
	("de_DE",	"LOC_CSE_ENTERTAINMENT_TRAIT_LARGEST_INFLUENCE_BONUS",		"+1 [ICON_AMENITIES] Amenity in every Stadium."	),

	("de_DE",	"LOC_CSE_ENTERTAINMENT_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CSE_ENTERTAINMENT} City-State"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CITY_STATES_TYPE_CSE_MARITIME",					"Maritime"	),
	
	("de_DE",	"LOC_CSE_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS",			"+1 [ICON_FOOD] Food and +1 [ICON_PRODUCTION] Production in the [ICON_CAPITAL] Capital."	),
	("de_DE",	"LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+1 [ICON_FOOD] Food and +1 [ICON_PRODUCTION] Production in every Lighthouse."		),
	("de_DE",	"LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS",			"+1 [ICON_FOOD] Food and +1 [ICON_PRODUCTION] Production in every Shipyard."	),
	("de_DE",	"LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS",		"+1 [ICON_FOOD] Food and +1 [ICON_PRODUCTION] Production in every Seaport."	),

	("de_DE",	"LOC_CSE_MARITIME_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CSE_MARITIME} City-State"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_ALAMUT_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_ALAMUT_NAME} city-state"		),
	("de_DE",	"LOC_CSE_ALAMUT_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_ALAMUT_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_ALAMUT_TRAIT_DESCRIPTION",			"Spies may choose from any promotion."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_AMPI_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_AMPI_NAME} city-state"		),
	("de_DE",	"LOC_CSE_AMPI_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_AMPI_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_AMPI_TRAIT_DESCRIPTION",			"Receive the [ICON_RESOURCE_CSE_GLASS] Glass luxury resource (not tradeable), which provides 6 [ICON_AMENITIES] Amenities. Plantations yield +1 [ICON_PRODUCTION] Production."	),
	...
	("de_DE",	"LOC_RESOURCE_CSE_GLASS_NAME",					"Glass"		),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_ANURADHAPURA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_ANURADHAPURA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_ANURADHAPURA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_ANURADHAPURA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_ANURADHAPURA_TRAIT_DESCRIPTION",			"Your builders may construct Dagoba improvements.[NEWLINE][NEWLINE] Dagobas yield +1 [ICON_CULTURE] Culture and +1 [ICON_FAITH] Faith, with additional +1 [ICON_FAITH] Faith for every adjacent Holy Site and +1 [ICON_CULTURE] Culture for every adjacent Theater Square. Additional [ICON_CULTURE] Culture and [ICON_FAITH] Faith as you advance through the Civics and Technology trees. Building your first Dagoba grants a free Relic."	),
	...
	("de_DE",	"LOC_IMPROVEMENT_CSE_DAGOBA_DESCRIPTION",			"Unlocks the Builder ability to construct a Dagoba.[NEWLINE][NEWLINE]Yields +1 [ICON_CULTURE] Culture and +1 [ICON_FAITH] Faith, with additional +1 [ICON_FAITH] Faith for every adjacent Holy Site and +1 [ICON_CULTURE] Culture for every adjacent Theater Square. Additional [ICON_CULTURE] Culture and [ICON_FAITH] Faith as you advance through the Civics and Technology trees. Building your first Dagoba grants a free Relic."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_AYNUK_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_AYNUK_NAME} city-state"		),
	("de_DE",	"LOC_CSE_AYNUK_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_AYNUK_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_AYNUK_TRAIT_DESCRIPTION",			"City Centers gain +1 [ICON_FOOD] Food and +1 [ICON_PRODUCTION] Production for each adjacent coastal tile."	),
	...
	("de_DE",	"ADJ_CSE_AYNUK_COAST_FOOD",					"+{1_num} [ICON_FOOD] Food from the adjacent coastal {1_Num : plural 1?tile; other?tiles;}."		),
	("de_DE",	"ADJ_CSE_AYNUK_COAST_PRODUCTION",			"+{1_num} [ICON_PRODUCTION] Production from the adjacent coastal {1_Num : plural 1?tile; other?tiles;}."		),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_AZCAPOTZALCO_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_AZCAPOTZALCO_NAME} city-state"		),
	("de_DE",	"LOC_CSE_AZCAPOTZALCO_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_AZCAPOTZALCO_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_AZCAPOTZALCO_TRAIT_DESCRIPTION",			"Earn alliance points 25% faster."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_BAIAE_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_BAIAE_NAME} city-state"		),
	("de_DE",	"LOC_CSE_BAIAE_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_BAIAE_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_BAIAE_TRAIT_DESCRIPTION",			"Entertainment Districts and Waterparks provide +1 [ICON_FAVOR] Diplomatic Favor per turn."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_BEIKTHANO_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_BEIKTHANO_NAME} city-state"		),
	("de_DE",	"LOC_CSE_BEIKTHANO_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_BEIKTHANO_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_BEIKTHANO_TRAIT_DESCRIPTION",			"Your cities gain +3 [ICON_RANGED] Ranged Strength and +5 City [ICON_STRENGTH] Defense Strength for each level of walls constructed."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_BUTUAN_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_BUTUAN_NAME} city-state"		),
	("de_DE",	"LOC_CSE_BUTUAN_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_BUTUAN_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_BUTUAN_TRAIT_DESCRIPTION",			"Your land units gain +2 [ICON_MOVEMENT] Movement when embarked and ignore additional [ICON_MOVEMENT] Movement costs from embarking and disembarking."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_CATALHOYUK_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_CATALHOYUK_NAME} city-state"		),
	("de_DE",	"LOC_CSE_CATALHOYUK_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_CATALHOYUK_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_CATALHOYUK_TRAIT_DESCRIPTION",			"Receive the [ICON_RESOURCE_CSE_LEATHER] Leather and [ICON_RESOURCE_CSE_WOOL] Wool Luxury resources (not tradeable), which provide 6 [ICON_AMENITIES] Amenities each."	),
	...
	("de_DE",	"LOC_RESOURCE_CSE_LEATHER_NAME",				"Leather"	),
	("de_DE",	"LOC_RESOURCE_CSE_WOOL_NAME",					"Wool"		),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_CHAN_CHAN_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_CHAN_CHAN_NAME} city-state"		),
	("de_DE",	"LOC_CSE_CHAN_CHAN_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_CHAN_CHAN_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_CHAN_CHAN_TRAIT_DESCRIPTION",			"Your Palace provides double yields, [ICON_AMENITIES] Amenities, and [ICON_HOUSING] Housing. Specialty districts provide +50% of their native yield when adjacent to a Government Plaza, Entertainment Complex or Waterpark district."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_CHETRO_KETL_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_CHETRO_KETL_NAME} city-state"		),
	("de_DE",	"LOC_CSE_CHETRO_KETL_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_CHETRO_KETL_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_CHETRO_KETL_TRAIT_DESCRIPTION",			"Your Builders may construct the Kiva unique improvement.[NEWLINE][NEWLINE]Kivas yield +2 [ICON_FAITH] Faith and +0.5 [ICON_HOUSING] Housing, with additional [ICON_FAITH] Faith, [ICON_FOOD] Food and [ICON_PRODUCTION] Production from adjacent Grass and Plains tiles as you progress through the Civics and Technology trees. Must be built on Desert or Desert Hills tiles, but not next to another Great Kiva."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_DAKAR_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_DAKAR_NAME} city-state"		),
	("de_DE",	"LOC_CSE_DAKAR_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_DAKAR_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_DAKAR_TRAIT_DESCRIPTION",			"Buildings within your Harbor districts provide +1 [ICON_GREATPERSON] Great Person Point toward [ICON_GREATMERCHANT] Great Merchants."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_DELOS_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_DELOS_NAME} city-state"		),
	("de_DE",	"LOC_CSE_DELOS_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_DELOS_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_DELOS_TRAIT_DESCRIPTION",			"Flat tiles with breathtaking appeal double their terrain yields in cities with an Entertainment Complex or Waterpark district."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_DELPHI_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_DELPHI_NAME} city-state"		),
	("de_DE",	"LOC_CSE_DELPHI_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_DELPHI_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_DELPHI_TRAIT_DESCRIPTION",			"Wonders exert +2 Loyalty Pressure and trigger a culture bomb upon completion."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_DJIBOUTI_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_DJIBOUTI_NAME} city-state"		),
	("de_DE",	"LOC_CSE_DJIBOUTI_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_DJIBOUTI_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_DJIBOUTI_TRAIT_DESCRIPTION",			"Shallow water tiles provide +1 [ICON_FOOD] Food. Additional +1 [ICON_FOOD] Food when you reach the Industrial Era."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_DODONA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_DODONA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_DODONA_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_DODONA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_DODONA_TRAIT_DESCRIPTION",			"[ICON_CIVICBOOSTED] Inspirations provide +10% of the cost for Civics during a [ICON_GLORY_GOLDEN_AGE] Golden Age, and additional Era Score during a [ICON_GLORY_DARK_AGE] Dark Age."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_ETZANOA_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_ETZANOA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_ETZANOA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_ETZANOA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_ETZANOA_TRAIT_DESCRIPTION",			"Neighborhood districts receive +1 [ICON_HOUSING] Housing for each adjacent district of the same type."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_GARAMA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_GARAMA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_GARAMA_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_GARAMA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_GARAMA_TRAIT_DESCRIPTION",			"+2 [ICON_FOOD] Food on Oases and adjacent land tiles. +1 [ICON_FOOD] Food on land tiles two away."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_GOBEKLI_TEPE_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_GOBEKLI_TEPE_NAME} city-state"		),
	("de_DE",	"LOC_CSE_GOBEKLI_TEPE_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_GOBEKLI_TEPE_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_GOBEKLI_TEPE_TRAIT_DESCRIPTION",			"Wonders provide +1 [ICON_CULTURE] Culture on domestic [ICON_TRADEROUTE] Trade Routes to their city."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_GUNDESHAPUR_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_GUNDESHAPUR_NAME} city-state"		),
	("de_DE",	"LOC_CSE_GUNDESHAPUR_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_GUNDESHAPUR_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_GUNDESHAPUR_TRAIT_DESCRIPTION",		"Receive two free [ICON_TECHBOOSTED] Eurekas upon entering a new era. Campus districts receive +1 [ICON_SCIENCE] Science for every two adjacent districts."	),
	
	("de_DE",	"LOC_CSE_GUNDESHAPUR_CAMPUS_ADJACENCY",			"+{1_num} [ICON_SCIENCE] Science from the adjacent {1_Num : plural 1?district; other?districts;}. (Gundeshapur)"		),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_HADAD_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_HADAD_NAME} city-state"		),
	("de_DE",	"LOC_CSE_HADAD_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_HADAD_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_HADAD_TRAIT_DESCRIPTION",			"Cities with an established [ICON_GOVERNOR] Governor receive +2 [ICON_AMENITIES] Amenities."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_HALIN_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_HALIN_NAME} city-state"		),
	("de_DE",	"LOC_CSE_HALIN_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_HALIN_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_HALIN_TRAIT_DESCRIPTION",			"Your cities produce +0.5 [ICON_FAITH] Faith per [ICON_CITIZEN] Population."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_HAVANA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_HAVANA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_HAVANA_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_HAVANA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_HAVANA_TRAIT_DESCRIPTION",			"Harbors produce [ICON_CULTURE] Culture equal to their adjacency bonus, and Theater Squares produce [ICON_GOLD] Gold equal to their adjacency bonus."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_HAZOR_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_HAZOR_NAME} city-state"		),
	("de_DE",	"LOC_CSE_HAZOR_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_HAZOR_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_HAZOR_TRAIT_DESCRIPTION",			"Units fight at full strength when [ICON_DAMAGED] Damaged."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_HORMUZ_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_HORMUZ_NAME} city-state"		),
	("de_DE",	"LOC_CSE_HORMUZ_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_HORMUZ_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_HORMUZ_TRAIT_DESCRIPTION",			"Cities with a Harbor district cannot be put under [ICON_UNDERSIEGE] Siege."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_HVALSEY_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_HVALSEY_NAME} city-state"			),
	("de_DE",	"LOC_CSE_HVALSEY_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_HVALSEY_NAME} Suzerain Bonus"		),
	("de_DE",	"LOC_CSE_HVALSEY_TRAIT_DESCRIPTION",			"Fishing Boat improvements within 2 tiles of Tundra, Snow or Ice yield +1 [ICON_FOOD] Food and +1 [ICON_PRODUCTION] Production."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_IQALUIT_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_IQALUIT_NAME} city-state"						),
	("de_DE",	"LOC_CSE_IQALUIT_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_IQALUIT_NAME} Suzerain Bonus"					),
	("de_DE",	"LOC_CSE_IQALUIT_TRAIT_DESCRIPTION",			"Tundra and Snow tiles adjacent to coast yield +2 [ICON_FOOD] Food."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_IZAPA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_IZAPA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_IZAPA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_IZAPA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_IZAPA_TRAIT_DESCRIPTION",			"[ICON_TECHBOOSTED] Eurekas provide +10% of the cost for Technologies during a [ICON_GLORY_GOLDEN_AGE] Golden Age, and additional Era Score during a [ICON_GLORY_DARK_AGE] Dark Age."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_JOHANNESBURG_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_JOHANNESBURG_NAME} city-state"		),
	("de_DE",	"LOC_CSE_JOHANNESBURG_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_JOHANNESBURG_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_JOHANNESBURG_TRAIT_DESCRIPTION",			"Industrial Zone buildings with regional yields provide +2 [ICON_PRODUCTION] Production and +4 [ICON_GOLD] Gold to Cities within 6 tiles."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_JOLO_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_JOLO_NAME} city-state"		),
	("de_DE",	"LOC_CSE_JOLO_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_JOLO_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_JOLO_TRAIT_DESCRIPTION",			"Receive the [ICON_RESOURCE_CSE_ABACA] Abacá and [ICON_RESOURCE_CSE_MANGOSTEEN] Mangosteen Luxury resources (not tradeable), which provide 6 [ICON_AMENITIES] Amenities each."	),
	...
	("de_DE",	"LOC_RESOURCE_CSE_MANGOSTEEN_NAME",			"Mangosteen"	),

	("de_DE",	"LOC_PEDIA_RESOURCES_PAGE_RESOURCE_CSE_ABACA_CHAPTER_HISTORY_PARA_1",		"Abacá is a species of banana native to the Philippines, grown as a commercial crop in the Philippines, Ecuador, and Costa Rica. The plant, also known as Manila hemp, has great economic importance, being harvested for its fiber, also called Manila hemp, extracted from the leaf-stems. The plant grows to 13–22 feet (4.0–6.7 m), and averages about 12 feet (3.7 m). The fiber was originally used for making twines and ropes; now most is pulped and used in a variety of specialized paper products including tea bags, filter paper and banknotes. Due to its strength, it is a sought after product and is the strongest of the natural fibers."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_KADESH_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_KADESH_NAME} city-state"		),
	("de_DE",	"LOC_CSE_KADESH_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_KADESH_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_KADESH_TRAIT_DESCRIPTION",			"Your heavy cavalry units gain the ability to push defending units back."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_KANNAUJ_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_KANNAUJ_NAME} city-state"		),
	("de_DE",	"LOC_CSE_KANNAUJ_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_KANNAUJ_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_KANNAUJ_TRAIT_DESCRIPTION",		"No war weariness from combat in your territory."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_KATARAGAMA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_KATARAGAMA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_KATARAGAMA_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_KATARAGAMA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_KATARAGAMA_TRAIT_DESCRIPTION",			"Tiles with fresh water access yield +1 [ICON_FAITH] Faith."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_KELANIYA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_KELANIYA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_KELANIYA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_KELANIYA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_KELANIYA_TRAIT_DESCRIPTION",			"Great Works of [ICON_GREATWORK_LANDSCAPE] Art yield +2 [ICON_FAITH] Faith and Great Works of [ICON_GREATWORK_WRITING] Writing yield +1 [ICON_CULTURE] Culture."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_KUHIKUGU_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_KUHIKUGU_NAME} city-state"		),
	("de_DE",	"LOC_CSE_KUHIKUGU_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_KUHIKUGU_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_KUHIKUGU_TRAIT_DESCRIPTION",			"Farms built adjacent to rainforest yield +1 [ICON_Food] Food and +2 [ICON_Gold] Gold."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_LIMA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_LIMA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_LIMA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_LIMA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_LIMA_TRAIT_DESCRIPTION",			"Your cities may build one more district than the [ICON_CITIZEN] Population would allow, if it has a Campus. Receive +20% [ICON_PRODUCTION] Production toward Campus districts."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_MACAU_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_MACAU_NAME} city-state"		),
	("de_DE",	"LOC_CSE_MACAU_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_MACAU_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_MACAU_TRAIT_DESCRIPTION",			"+25% [ICON_TOURISM] Tourism toward civilizations to which you have a [ICON_TRADEROUTE] Trade Route."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_MAI_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_MAI_NAME} city-state"		),
	("de_DE",	"LOC_CSE_MAI_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_MAI_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_MAI_TRAIT_DESCRIPTION",		"Receive the [ICON_RESOURCE_CSE_BEESWAX] Beeswax and [ICON_RESOURCE_CSE_BETEL_NUT] Betel Nut Luxury resources (not tradeable), which provide 6 [ICON_AMENITIES] Amenities each."	),
	...
	("de_DE",	"LOC_RESOURCE_CSE_BEESWAX_NAME",		"Beeswax"		),
	("de_DE",	"LOC_RESOURCE_CSE_BETEL_NUT_NAME",		"Betel Nut"		),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_MAINGMAW_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_MAINGMAW_NAME} city-state"		),
	("de_DE",	"LOC_CSE_MAINGMAW_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_MAINGMAW_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_MAINGMAW_TRAIT_DESCRIPTION",			"Improved tiles adjacent to a river provide +1 [ICON_FOOD] Food and +1 [ICON_GOLD] Gold."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_MARRAKECH_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_MARRAKECH_NAME} city-state"		),
	("de_DE",	"LOC_CSE_MARRAKECH_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_MARRAKECH_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_MARRAKECH_TRAIT_DESCRIPTION",			"Your builders may construct the Riad unique improvement."	),
	...
	("de_DE",	"LOC_IMPROVEMENT_CSE_RIAD_DESCRIPTION",			"Unlocks the Builder ability to construct a Riad.[NEWLINE][NEWLINE]Yields +1 [ICON_FOOD] Food, +1 [ICON_CULTURE] Culture and +0.5 [ICON_HOUSING] Housing. +1 [ICON_FOOD] Food for each adjacent Oasis or for every two adjacent Floodplains, and +1 [ICON_CULTURE] Culture for every two adjacent Riads. Grants +1 [ICON_GOLD] Gold on [ICON_TRADEROUTE] Trade Routes from this city. Must be built on Desert or Desert Hill tiles."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_MEGIDDO_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_MEGIDDO_NAME} city-state"		),
	("de_DE",	"LOC_CSE_MEGIDDO_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_MEGIDDO_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_MEGIDDO_TRAIT_DESCRIPTION",			"Encampment districts provide +1 [ICON_PRODUCTION] Production and +2 [ICON_GOLD] Gold on international [ICON_TRADEROUTE] Trade Routes starting in their City."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_MEHRGARH_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_MEHRGARH_NAME} city-state"		),
	("de_DE",	"LOC_CSE_MEHRGARH_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_MEHRGARH_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_MEHRGARH_TRAIT_DESCRIPTION",			"Receive +25% yields from plot harvest and feature removals."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_MOMBASA_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_MOMBASA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_MOMBASA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_MOMBASA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_MOMBASA_TRAIT_DESCRIPTION",			"Specialty districts receive minor adjacency bonuses from coastal tiles."	),
	...
	("de_DE",	"LOC_CSE_MOMBASA_FAITH",						"+{1_num} [ICON_FAITH] Faith from the adjacent coastal {1_Num : plural 1?tile; other?tiles;}."	),
	("de_DE",	"LOC_CSE_MOMBASA_SCIENCE",						"+{1_num} [ICON_SCIENCE] Science from the adjacent coastal {1_Num : plural 1?tile; other?tiles;}."	),
	("de_DE",	"LOC_CSE_MOMBASA_CULTURE",						"+{1_num} [ICON_CULTURE] Culture from the adjacent coastal {1_Num : plural 1?tile; other?tiles;}."	),
	("de_DE",	"LOC_CSE_MOMBASA_PRODUCTION",					"+{1_num} [ICON_PRODUCTION] Production from the adjacent coastal {1_Num : plural 1?tile; other?tiles;}."	),
	("de_DE",	"LOC_CSE_MOMBASA_FOOD",							"+{1_num} [ICON_FOOD] Food from the adjacent coastal {1_Num : plural 1?tile; other?tiles;}."	),
	("de_DE",	"LOC_CSE_MOMBASA_GOLD",							"+{1_num} [ICON_GOLD] Gold from the adjacent coastal {1_Num : plural 1?tile; other?tiles;}."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_MONACO_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_MONACO_NAME} city-state"		),
	("de_DE",	"LOC_CSE_MONACO_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_MONACO_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_MONACO_TRAIT_DESCRIPTION",			"Buildings within Entertainment Complex or Water Park districts receive +2 [ICON_TOURISM] Tourism and enough [ICON_GOLD] Gold to pay for their maintenance."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_MZIZIMA_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_MZIZIMA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_MZIZIMA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_MZIZIMA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_MZIZIMA_TRAIT_DESCRIPTION",			"Your cities with an established [ICON_GOVERNOR] Governor receive +15% [ICON_CITIZEN] Population Growth."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_NALANDA_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_NALANDA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_NALANDA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_NALANDA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_NALANDA_TRAIT_DESCRIPTION",			"Happy cities receive +5% [ICON_FAITH] Faith with a Campus, and +5% [ICON_SCIENCE] Science with a Holy Site, each increasing to +10% in Ecstatic cities."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_NASSAU_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_NASSAU_NAME} city-state"		),
	("de_DE",	"LOC_CSE_NASSAU_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_NASSAU_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_NASSAU_TRAIT_DESCRIPTION",				"Yields from plundering sea [ICON_TRADEROUTE] Trade Routes are doubled."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_PALMYRA_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_PALMYRA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_PALMYRA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_PALMYRA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_PALMYRA_TRAIT_DESCRIPTION",			"Holy Site buildings provide +1 [ICON_GOLD] Gold to their Cities for each foreign [ICON_TRADEROUTE] Trade Route passing through."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_PHASIS_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_PHASIS_NAME} city-state"		),
	("de_DE",	"LOC_CSE_PHASIS_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_PHASIS_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_PHASIS_TRAIT_DESCRIPTION",			"Forest tiles yield +1 [ICON_PRODUCTION] Production if adjacent to another Forest tile. Lumber Mills yield +2 [ICON_GOLD] Gold when adjacent to a river."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_PORT_ROYAL_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_PORT_ROYAL_NAME} city-state"		),
	("de_DE",	"LOC_CSE_PORT_ROYAL_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_PORT_ROYAL_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_PORT_ROYAL_TRAIT_DESCRIPTION",				"[ICON_TRADEROUTE] Trade Routes yield +1 [ICON_GOLD] Gold and +1 [ICON_PRODUCTION] Production for each Plantation at the destination."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_QATNA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_QATNA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_QATNA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_QATNA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_QATNA_TRAIT_DESCRIPTION",			"Industrial Zone buildings may be purchased with [ICON_FAITH] Faith and provide +1 [ICON_PRODUCTION] Production."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_SALE_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_SALE_NAME} city-state"		),
	("de_DE",	"LOC_CSE_SALE_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_SALE_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_SALE_TRAIT_DESCRIPTION",			"Naval Raider units gain an extra attack."	),
	...
	("de_DE",	"LOC_CSE_SALE_SUZ_NAME",					"Salé Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_SALE_SUZ_DESC",					"+1 Attack for Naval Raiders (Salé)"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_SAMARKAND_DESCRIPTION",		"{LOC_CIVILIZATION_SAMARKAND_NAME} city-state"		),
	("de_DE",	"LOC_SAMARKAND_TRAIT_NAME",						"{LOC_CIVILIZATION_SAMARKAND_NAME} Suzerain Bonus"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_SAMARQAND_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_SAMARQAND_NAME} city-state"		),
	("de_DE",	"LOC_CSE_SAMARQAND_TRAIT_NAME",						"{LOC_CIVILIZATION_CSE_SAMARQAND_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_SAMARQAND_TRAIT_DESCRIPTION",				"Your Civilization gains +2% [ICON_SCIENCE] Science for each [ICON_GREATPERSON] Great Person it has ever earned, up to a total of +30%."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_SANAA_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_SANAA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_SANAA_TRAIT_NAME",						"{LOC_CIVILIZATION_CSE_SANAA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_SANAA_TRAIT_DESCRIPTION",				"[ICON_TRADEROUTE] Trade Routes yield +1 [ICON_FOOD] Food for each domestic [ICON_TRADINGPOST] Trading Post they pass through."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_SEUTHOPOLIS_DESCRIPTION",			"{LOC_CIVILIZATION_CSE_SEUTHOPOLIS_NAME} city-state"		),
	("de_DE",	"LOC_CSE_SEUTHOPOLIS_TRAIT_NAME",						"{LOC_CIVILIZATION_CSE_SEUTHOPOLIS_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_SEUTHOPOLIS_TRAIT_DESCRIPTION",				"Eliminating an enemy unit provides [ICON_GOLD] Gold equal to its [ICON_STRENGTH] Combat Strength."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_SHAHR_E_SUKHTE_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_SHAHR_E_SUKHTE_NAME} city-state"		),
	("de_DE",	"LOC_CSE_SHAHR_E_SUKHTE_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_SHAHR_E_SUKHTE_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_SHAHR_E_SUKHTE_TRAIT_DESCRIPTION",				"Your cities earn +15% bonus [ICON_CULTURE] Culture output when you are not at war with any civilization."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_SIDON_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_SIDON_NAME} city-state"		),
	("de_DE",	"LOC_CSE_SIDON_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_SIDON_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_SIDON_TRAIT_DESCRIPTION",			"+1 [ICON_MOVEMENT] Movement for all Civilian units."	),
	...
	("de_DE",	"LOC_CSE_SIDON_SUZ_DESC",					"+1 [ICON_MOVEMENT] for Civilians (Sidon)"	),

-----------------------------------------------
-- City-State | Singapore
-----------------------------------------------
	
	("de_DE",	"LOC_CIVILIZATION_CSE_SINGAPORE_NAME",			"Singapore"	),
	("de_DE",	"LOC_CIVILIZATION_CSE_SINGAPORE_ADJECTIVE",		"Singapore"	),
	("de_DE",	"LOC_CIVILIZATION_CSE_SINGAPORE_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_SINGAPORE_NAME} city-state"		),
	("de_DE",	"LOC_CSE_SINGAPORE_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_SINGAPORE_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_SINGAPORE_TRAIT_DESCRIPTION",			"Your civilization gains +1 [ICON_GOLD] Gold for each [ICON_ENVOY] Envoy sent to a city-state."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_SRI_KSETRA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_SRI_KSETRA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_SRI_KSETRA_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_SRI_KSETRA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_SRI_KSETRA_TRAIT_DESCRIPTION",			"Holy Sites provide [ICON_FOOD] Food equal to their [ICON_FAITH] Faith adjacency bonus."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_TANGIER_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_TANGIER_NAME} city-state"		),
	("de_DE",	"LOC_CSE_TANGIER_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_TANGIER_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_TANGIER_TRAIT_DESCRIPTION",		"Receive two free [ICON_CIVICBOOSTED] Inspirations upon entering a new era. Theater districts receive +1 [ICON_CULTURE] Culture for every two adjacent districts."	),
	
	("de_DE",	"LOC_CSE_TANGIER_THEATER_ADJACENCY",		"+{1_num} [ICON_CULTURE] Culture from the adjacent {1_Num : plural 1?district; other?districts;}. (Tangier)"		),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_TAOS_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_TAOS_NAME} city-state"		),
	("de_DE",	"LOC_CSE_TAOS_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_TAOS_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_TAOS_TRAIT_DESCRIPTION",			"Quarried resources yield +2 [ICON_SCIENCE] Science and +1 [ICON_PRODUCTION] Production."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_TEYUNA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_TEYUNA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_TEYUNA_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_TEYUNA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_TEYUNA_TRAIT_DESCRIPTION",			"Tiles in your territory that are adjacent to a mountain yield +1 [ICON_PRODUCTION] Production."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_TISSAMAHARAMA_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_TISSAMAHARAMA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_TISSAMAHARAMA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_TISSAMAHARAMA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_TISSAMAHARAMA_TRAIT_DESCRIPTION",			"Land units (Recon, Melee, Ranged, and Anti-Cavalry) gain +5 [ICON_STRENGTH] Combat Strength."	),

	("de_DE",	"LOC_CSE_TISSAMAHARAMA_STRENGTH",					"+{1_Amount} Combat Bonus (Tissamaharama)"	),
	
	("de_DE",	"LOC_CSE_TISSAMAHARAMA_STRENGTH_NAME",				"Tissamaharama Bonus"	),
	("de_DE",	"LOC_CSE_TISSAMAHARAMA_STRENGTH_DESC",				"+{1_Amount} Combat Bonus (Tissamaharama)"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_TUNERIUT_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_TUNERIUT_NAME} city-state"		),
	("de_DE",	"LOC_CSE_TUNERIUT_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_TUNERIUT_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_TUNERIUT_TRAIT_DESCRIPTION",			"Receive the [ICON_RESOURCE_CSE_WALRUS] Walrus luxury resource (not tradeable), which provides 6 [ICON_AMENITIES] Amenities. Harbors receive major adjacency bonuses from snow and ice."	),
	...
	("de_DE",	"LOC_RESOURCE_CSE_WALRUS_NAME",					"Walrus"	),

	("de_DE",	"ADJ_CSE_TUNERIUT_ICE_GOLD",					"+{1_num} [ICON_GOLD] Gold from the adjacent ice {1_Num : plural 1?tile; other?tiles;}."	),
	("de_DE",	"ADJ_CSE_TUNERIUT_SNOW_GOLD",					"+{1_num} [ICON_GOLD] Gold from the adjacent snow {1_Num : plural 1?tile; other?tiles;}."	),

	("de_DE",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_TUNERIUT_CHAPTER_HISTORY_PARA_1",	"Native Point is a peninsula in Kivalliq Region, Nunavut, Canada. It is located on Southampton Island's Bell Peninsula at the mouth of Native Bay. It is notable for being the location of an abandoned Sadlermiut settlement, currently an archaeological site. The Sadlermiut settlement, situated on the west side of the point, was abandoned after the Sadlermiut became extinct during the winter between 1902 and 1903."	),
	("de_DE",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_TUNERIUT_CHAPTER_HISTORY_PARA_2",	"The material culture of the Sadlermiut were limited to chipped stone tools and various manufactured organic artifacts. Among the artifacts found in the site were human figurines called aarnguaq, which was probably used for a healing ritual. This indicates that the Sadlermiut were shamanistic. In addition, multiple human remains were found on the site. Merbs and Wilson grouped the burials intro three series, each with chronological significance: the 'village' graves, which were thought to be the oldest, 'peripheral' burials located northeast and southeast of the settlement which were given of intermediate age, and a series of 'meat-cache' graves, suggested to primarily represent casualties from the 1902-1903 epidemic which decimated the Sadlermiut population."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_UGARIT_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_UGARIT_NAME} city-state"		),
	("de_DE",	"LOC_CSE_UGARIT_TRAIT_NAME",				"{LOC_CIVILIZATION_CSE_UGARIT_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_UGARIT_TRAIT_DESCRIPTION",			"Cities with an established [ICON_GOVERNOR] Governor receives +50% [ICON_PRODUCTION] Production towards naval units."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_URGENCH_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_URGENCH_NAME} city-state"		),
	("de_DE",	"LOC_CSE_URGENCH_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_URGENCH_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_URGENCH_TRAIT_DESCRIPTION",			"+1 [ICON_TRADEROUTE] Trade Route capacity. International [ICON_TRADEROUTE] Trade Routes from cities settled on desert tiles yield +4 [ICON_GOLD] Gold."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_VADUZ_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_VADUZ_NAME} city-state"		),
	("de_DE",	"LOC_CSE_VADUZ_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_VADUZ_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_VADUZ_TRAIT_DESCRIPTION",			"Buildings cost 15% less [ICON_GOLD] Gold to purchase."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_VALABHI_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_VALABHI_NAME} city-state"		),
	("de_DE",	"LOC_CSE_VALABHI_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_VALABHI_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_VALABHI_TRAIT_DESCRIPTION",			"Campus districts provide [ICON_FAITH] Faith equal to their adjacency bonus and their buildings may be purchased with [ICON_FAITH] Faith."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_VIENNA_DESCRIPTION",		"{LOC_CIVILIZATION_CSE_VIENNA_NAME} city-state"		),
	("de_DE",	"LOC_CSE_VIENNA_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_VIENNA_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_VIENNA_TRAIT_DESCRIPTION",				"Your cities with an established [ICON_GOVERNOR] Governor can purchase buildings for 25% cheaper."	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CIVILIZATION_CSE_WYAM_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_WYAM_NAME} city-state"		),
	("de_DE",	"LOC_CSE_WYAM_TRAIT_NAME",					"{LOC_CIVILIZATION_CSE_WYAM_NAME} Suzerain Bonus"	),
	("de_DE",	"LOC_CSE_WYAM_TRAIT_DESCRIPTION",			"Receive the [ICON_RESOURCE_CSE_SALMON] Wild Salmon luxury resource (not tradeable), which provides 6 [ICON_AMENITIES] Amenities. Fishing Boat improvements yield +1 [ICON_CULTURE] Culture."	),
	...
	("de_DE",	"LOC_RESOURCE_CSE_SALMON_NAME",				"Wild Salmon"	),

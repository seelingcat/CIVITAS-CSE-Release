...
-----------------------------------------------
	...
	("de_DE",	"LOC_CSE_AGRICULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",	"+2 [ICON_FOOD] Food in every Food Market and Shopping Mall."	),

-----------------------------------------------
-- Consular
-----------------------------------------------

	("de_DE",	"LOC_CITY_STATES_TYPE_CSE_CONSULAR",					"Consular"	),
	
	("de_DE",	"LOC_CSE_CONSULAR_TRAIT_SMALL_INFLUENCE_BONUS",			"+2 Loyalty Pressure in the [ICON_CAPITAL] Capital."	),
	("de_DE",	"LOC_CSE_CONSULAR_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 Loyalty in every City."		),
	("de_DE",	"LOC_CSE_CONSULAR_TRAIT_LARGE_INFLUENCE_BONUS",			"+2 Loyalty Pressure in every City."	),
	("de_DE",	"LOC_CSE_CONSULAR_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 Loyalty Pressure in every City with an established [ICON_GOVERNOR] Governor."	),

	("de_DE",	"LOC_CSE_CONSULAR_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CSE_CONSULAR} City-State"	),
...
-----------------------------------------------
	...
	("de_DE",	"LOC_CSE_ENTERTAINMENT_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+1 [ICON_AMENITIES] Amenity in every Arena or Ferris Wheel."		),
	("de_DE",	"LOC_CSE_ENTERTAINMENT_TRAIT_LARGE_INFLUENCE_BONUS",		"+1 [ICON_AMENITIES] Amenity in every Zoo or Aquarium."	),
	("de_DE",	"LOC_CSE_ENTERTAINMENT_TRAIT_LARGEST_INFLUENCE_BONUS",		"+1 [ICON_AMENITIES] Amenity in every Stadium or Aquatics Center."	);

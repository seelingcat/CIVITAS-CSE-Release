...
SELECT	'MINOR_CIV_CSE_JOHANNESBURG_TRAIT',	'CSE_JOHANNESBURG_SUZERAIN_REGIONAL_PRODUCTION'
WHERE EXISTS (SELECT * FROM Civilizations WHERE CivilizationType = 'CIVILIZATION_CSE_JOHANNESBURG');

INSERT INTO TraitModifiers
		(TraitType,							ModifierId							)
SELECT	'MINOR_CIV_CSE_JOHANNESBURG_TRAIT',	'CSE_JOHANNESBURG_SUZERAIN_REGIONAL_GOLD'
WHERE EXISTS (SELECT * FROM Civilizations WHERE CivilizationType = 'CIVILIZATION_CSE_JOHANNESBURG');
